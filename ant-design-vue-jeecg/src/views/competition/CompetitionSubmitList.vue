<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('大赛提交记录表')">导出</a-button>
    ...
    <competition-submit-modal ref="modalForm" @ok="modalFormOk"></competition-submit-modal>
  </a-card>
</template>
...
<script>
  ...
  import CompetitionSubmitModal from './modules/CompetitionSubmitModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/competition/competitionSubmit/list",
          delete: "/competition/competitionSubmit/delete",
          deleteBatch: "/competition/competitionSubmit/deleteBatch",
          exportXlsUrl: "/competition/competitionSubmit/exportXls",
          importExcelUrl: "competition/competitionSubmit/importExcel",
