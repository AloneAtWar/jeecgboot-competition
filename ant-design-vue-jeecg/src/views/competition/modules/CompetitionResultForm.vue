        ...
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="大赛" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="competitionId">
              <a-input v-model="model.competitionId" placeholder="请输入大赛"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/competition/competitionResult/add",
          edit: "/competition/competitionResult/edit",
          queryById: "/competition/competitionResult/queryById"
        }
      }
    },
    computed: {
